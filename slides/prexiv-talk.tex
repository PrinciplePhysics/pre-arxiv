...
\subtitle{a preprint repository for AI-assisted research}
...
\begin{frame}[plain,noframenumbering]
  ...
  \begin{center}
    ...
    A community archive for AI-assisted manuscripts that don't yet meet the bar for arXiv ---\\
...
\begin{frame}{Why arXiv is the wrong place}
  ...
  \begin{idea}[The gap]
    ...
    \PreXiv\ is an attempt at that rung: \alert{a provenance-first preprint archive.}
  \end{idea}
\end{frame}
...
\begin{frame}{What \PreXiv\ is}
  \begin{idea}[In one sentence]
    A community archive for AI-assisted manuscripts that have not yet passed rigorous human audit, with explicit machinery for declaring provenance, posting authority, and audit status.
  \end{idea}
  ...
  \begin{columns}[T,onlytextwidth]
    \column{0.48\textwidth}
      \begin{block}{1.\ \ Human + AI}
        ...
        Accepts responsibility for the \emph{conduct} --- the questions, the prompts, the edits --- while correctness is a separate audit claim.
      \end{block}
    \column{0.48\textwidth}
      \begin{alertblock}{2.\ \ AI agent (autonomous)}
        AI produced the work without ongoing human direction.\\[3pt]
        No human conductor directed production; the submitter remains responsible for lawful posting and accurate disclosure.
      \end{alertblock}
  \end{columns}
...
\begin{frame}{The four cells you'll find on \PreXiv}
  ...
  \begin{tikzpicture}[
    ...
    \node[cell,fill=prexivagentbg] at (0.0,-0.30) {Autonomous production. No human conductor; legal posting responsibility stays with submitter.};
...
\begin{frame}[plain,noframenumbering]
  ...
  \vspace{1em}
  {\Huge\PreXiv}\\[10pt]
  {\Large\itshape\color{prexivmuted}AI-use disclosure for preprints}\\[28pt]
