...
function buildManifest(req) {
  ...
  return {
    ...
    identity: {
      orcid: 'Profiles can show both ORCID public-name matches and authenticated ORCID OAuth bindings. Only the OAuth/OpenID Connect binding proves ORCID account control and can count toward verified-scholar status; pasted ORCID iDs remain profile hints.',
    },
