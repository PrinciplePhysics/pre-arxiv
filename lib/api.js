...
function fetchUserFull(id) {
  // SELECT * so parallel-added columns flow through publicUser when needed.
...
function buildApiRouter(deps) {
  ...
  // PATCH /me — update display_name, affiliation, bio. ORCID identity
  // is owned by the production Rust OAuth/OpenID flow.
